...
# Exercise #1
#
# -Add to the class NavigationBar dropdown for Phones & PDAs and methods that select from
# dropdown options Phones and PDAs
# -For other dropdowns create methods to select options such as scanners, printers, web cameras

# Exercise #2
#
# -Add to the class HomePage methods to select options such as scanners, printers,
# web cameras, phones using the NavigationBar class
...
# -Execute tests and perform debugging if needed
